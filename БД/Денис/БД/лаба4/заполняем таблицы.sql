...
use ФАЙЛОВАЯ_ГРУППА;
        ...
        values (5, 'Хартанович Екатерина Александровна', '11.03.1995'),        
          (6, 'Горбач Елизавета Юрьевна',    '07.12.1995'),
           (7, 'Зыкова Кристина Дмитриевна',  '12.10.1995'),
           (8, 'Шенец Екатерина Сергеевна',   '08.01.1995'),
           (9, 'Шитик Алина Игоревна',  '02.08.1995');       
insert into STUDENT (IDGROUP, NAME, BDAY)
    values (13, 'Силюк Валерия Ивановна',         '12.07.1994'),
           (14, 'Сергель Виолетта Николаевна',    '06.03.1994'),
           (15, 'Добродей Ольга Анатольевна',     '09.11.1994'),
           (16, 'Подоляк Мария Сергеевна',        '04.10.1994'),
           (17, 'Никитенко Екатерина Дмитриевна', '08.01.1994'),
           (18, 'Яцкевич Галина Иосифовна',       '02.08.1993'),
           (6, 'Осадчая Эла Васильевна',         '07.12.1993'),
           (7, 'Акулова Елена Геннадьевна',      '02.12.1993'),
           (8, 'Плешкун Милана Анатольевна',     '08.03.1992'),
           (9, 'Буянова Мария Александровна',    '02.06.1992'),
           (10, 'Харченко Елена Геннадьевна',     '11.12.1992'),
           (11, 'Крученок Евгений Александрович', '11.05.1992'),
           (12, 'Бороховский Виталий Петрович',   '09.11.1992'),
           (5, 'Мацкевич Надежда Валерьевна',    '01.11.1992'),
...
insert into PROGRESS (SUBJECT, IDSTUDENT, PDATE, NOTE)
    values ('ОАиП', 1030,  '01.10.2013',6),
           ('ОАиП', 1031,  '01.10.2013',8),
           ('ОАиП', 1032,  '01.10.2013',7),
           ('ОАиП', 1033,  '01.10.2013',5),
           ('ОАиП', 1035,  '01.10.2013',4)
insert into PROGRESS (SUBJECT, IDSTUDENT, PDATE, NOTE)
